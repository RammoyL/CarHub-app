...
const CarCard = ({ car }: CarCardProps ) => {
    ...
    <div className='car-card group'>
        ...
        <p className='flex mt-6 text-[32px] leading-[36px]
        font-extrabold'>
            <span className='self-start text-[14px] leading-[16px]
            font-semibold'>$</span>
            {carRent}
            <span className='self-end text-[14px] leading-[16px]
            font-medium'>
                /day
            </span>
        </p>

    <div className='relative w-full h-40 may-3 object-contain'>
    ...
    <div className='relative flex w-full mt-2'>
        ...
        <div className='car-card__btn-container'>
            <CustomButton
                ...
                textStyles='text-white text-[14px] leading-[15px]
                font-bold'
